...
class VariationOperator(ABC):
    """Abstract base class for variation operators (e.g., mutation, crossover) used in prompt evolution. Args: name: Name of the operator (defaults to class name). operator_type: Operator category ('mutation', 'crossover', or 'hybrid'). description: Short description of the operator's functionality."""
